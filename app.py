...
if uploaded_file:
    ...
    if df is not None and not df.empty:
        ...
        if num_theses == 2:
        ...
        elif num_theses > 2 and variance_homogeneity and all(p > 0.05 for p in normality_results.values()):
            ...
            if anova["p-unc"].values[0] < 0.05:
                ...
                # Corregge i nomi delle colonne per identificare correttamente i p-value
